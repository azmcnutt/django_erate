...
#     USAC_498_STATUS, USAC_URBAN_RURAL, YESNO, USAC_C2_BUDGET_ALGORITHM, \
#     USAC_C2_BUDGET_VERSION, USAC_470_STATUS, USAC_INSTALLMENT_TYPE, \
#     USAC_470_FORM_VERSION
...
#         help_text='The date and time this record was created in Django.',
#         auto_now_add=True,
#     )
...
#         blank=True,
#     )
#     consulting_firm_city = models.CharField(
#         verbose_name='Consulting Firm City',
#         help_text='City for consulting firm.',
#         max_length=100,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     consulting_firm_state = models.CharField(
#         verbose_name='Consulting Firm State',
#         help_text='State for consulting firm.',
#         max_length=2,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     consulting_firm_zipcode = models.CharField(
#         verbose_name='Consulting Firm Zip Code',
#         help_text='Zip code for consulting firm.',
#         max_length=10,
#         unique=False,
#         null=True,
#         blank=True,
...
#         verbose_name='Consultant\'s Name',
#         help_text='Name of individual consultant.',
#         max_length=255,
#         unique=False,
#         null=False,
#         blank=False,
#     )
#     consultant_phone = models.CharField(
#         verbose_name='Consultant\'s Phone',
#         help_text='Contact phone number for the individual consultant.',
#         max_length=15,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     consultant_phone_ext = models.CharField(
#         verbose_name='Consultant\'s Phone Ext',
#         help_text='Contact phone number extension for individual consultant.',
#         max_length=10,
#         unique=False,
#         null=True,
#         blank=True,
...
#         verbose_name='Consultant\'s Email',
#         help_text='Email for the individual consultant.',
#         max_length=255,
#         unique=False,
#         null=True,
#         blank=True,
...
#         verbose_name = 'Consultant Information'
#         verbose_name_plural = 'Consultants Information'
...
#     def get_absolute_url(self):
#         return reverse('core:consultant', kwargs={'pk': self.pk})


# # https://opendata.usac.org/E-Rate/E-Rate-C2-Budget-Tool-Data-FY2021-/6brt-5pbv/about_data
# class C2Budget(models.Model):
#     entity = models.ForeignKey(
#         Enitity,
#         on_delete=models.CASCADE,
#         verbose_name='C2 Budget Parent Organization',
#         help_text=(
#             'Billed Entity. Also referred to as the Budgeted Entity.'
#         ),
#         related_name='c2_budgets_entity',
#         null=False,
#         blank=False,
#     )
#     consulting_firm = models.ForeignKey(
#         ConsultingFirm,
#         on_delete=models.SET_NULL,
#         verbose_name='Consulting Firm',
#         help_text='Consulting firm associated with this C2 budget.',
#         related_name='c2_budgets_consulting_firm',
#         null=True,
#         blank=True,
#     )
#     c2_budget_cycle = models.CharField(
#         verbose_name='C2 Budget Cycle',
#         help_text='Funding Years associated with the C2 budget.',
#         max_length=12,
#         unique=False,
#         null=False,
#         blank=False,
#     )
#     child_entity_count = models.IntegerField(
#         verbose_name='Child Entity Count',
#         help_text=(
#             'Number of child entities for the budgeted entity that '
#             'includes schools or libraries.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     c2_budget_algorithm = models.CharField(
#         verbose_name='C2 Budget Algorithm',
#         help_text='Method for calculating the C2 budget.',
#         max_length=50,
#         choices=USAC_C2_BUDGET_ALGORITHM,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     full_time_students = models.IntegerField(
#         verbose_name='Full Time Students',
#         help_text=(
#             'C2 budget student count for the budgeted entity based on '
#             'a committed FCC Form 471, a certified FCC Form 471, or '
#             'the entity profile.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     library_square_footage = models.IntegerField(
#         verbose_name='Library Square Footage',
#         help_text=(
#             'Total library square footage for the budgeted entity '
#             'based on a committed FCC Form 471, a certified FCC Form '
#             '471, or the entity profile.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     school_student_multiplier = models.DecimalField(
#         verbose_name='School Student Multiplier',
#         help_text=(
#             'Student count multiplier used to derive the C2 budget for '
#             'the budget cycle.'
#         ),
#         max_digits=5,
#         decimal_places=2,
...
#         blank=True,
#     )
#     library_multiplier = models.DecimalField(
#         verbose_name='Library Multiplier',
#         help_text=(
#             'Library square footage multiplier used to derive the C2 '
#             'budget for the budget cycle.'
#         ),
#         max_digits=5,
#         decimal_places=2,
#         unique=False,
...
#         blank=True,
#     )
#     c2_budget_amount = models.DecimalField(
#         verbose_name='C2 Budget Amount',
#         help_text='The current C2 budget for the budgeted entity.',
#         max_digits=10,
#         decimal_places=2,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     c2_budget_version = models.CharField(
#         verbose_name='C2 Budget Version',
#         help_text='Version identifier for the C2 budget.',
#         choices=USAC_C2_BUDGET_VERSION,
#         max_length=20,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     funded_c2_budget_amount = models.DecimalField(
#         verbose_name='Funded C2 Budget Amount',
#         help_text=(
#             'Total pre-discount funded amount for the budgeted entity '
#             'from C2 FRNs including cost allocations from consortium '
#             'applications.'
#         ),
#         max_digits=10,
#         decimal_places=2,
...
#         blank=True,
#     )
#     pending_c2_budget_amount = models.DecimalField(
#         verbose_name='Pending C2 Budget Amount',
#         help_text=(
#             'Total pre-discount pending (or in-review) amount for the '
#             'budgeted entity from C2 FRNs including cost allocations '
#             'from consortium applications.'
#         ),
#         max_digits=10,
#         decimal_places=2,
#         unique=False,
...
#         blank=True,
#     )
#     available_c2_budget_amount = models.DecimalField(
#         verbose_name='Available C2 Budget Amount',
#         help_text=(
#             'Calculated as follows: C2 Budget - Funded C2 Amount - '
#             'Pending C2 Amount.  Remaining funds still available for '
#             'the budget cycle and budgeted entity. '
#         ),
#         max_digits=10,
#         decimal_places=2,
#         unique=False,
...
#     class Meta:
#         ordering = ('entity', 'c2_budget_cycle',)
#         verbose_name = 'C2 Budget Data'
#         verbose_name_plural = 'C2 Budgets Data'
...
#     def get_absolute_url(self):
#         return reverse('core:c2budget', kwargs={'pk': self.pk})


# # https://opendata.usac.org/E-Rate/E-Rate-Open-Competitive-Bidding-Basic-Information-/jp7a-89nd/about_data
# class Form470BasicInfo(models.Model):
#     row_id = models.CharField(
#         verbose_name='470 Row ID',
#         help_text=(
#             'The Row ID from the USAC OData service for this 470 Basic '
#             'Information Data.'
#         ),
#         max_length=32,
#         unique=True,
...
#         help_text=(
#             'Unique application number generated at the time '
#             'applicants begin to file the FCC Form 470. Applicants '
#             'can request funding for multiple services under the same '
#             'application number.'
#         ),
#         max_length=12,
#         unique=False,
...
#         blank=False,
#     )
#     form_nickname = models.CharField(
#         verbose_name='Form Nickname',
#         help_text=(
#             'Nickname given to an application by an applicant when '
#             'filling their FCC Form 470.'
#         ),
#         max_length=255,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     f470_number = models.URLField(
#         verbose_name='Form PDF',
#         help_text=(
#             'Link to download the original submitted FCC Form 470 as a '
#             'PDF.'
#         ),
#         max_length=255,
#         unique=True,
...
#         blank=True,
#     )
#     funding_year = models.ForeignKey(
#         ErateFundingYear,
#         on_delete=models.CASCADE,
#         verbose_name='Funding Year',
#         help_text='Funding year for the FCC Form 470.',
#         related_name='form_470_fy',
#         null=False,
#         blank=False,
#     )
#     f470_status = models.CharField(
#         verbose_name='Form Status',
#         help_text='Current status of the FCC Form 470.',
#         max_length=50,
#         choices=USAC_470_STATUS,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     allowable_contract_date = models.DateField(
#         verbose_name='Allowable Contract Date',
#         help_text=(
#             'Earliest date on which an applicant can sign a contract '
#             'for contracted services or enter into an arrangement for '
#             'tariffed (T) or month to-month (MTM) services with a '
#             'service provider is 28 days after the certified date.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
...
#         help_text=(
#             'Exact date and time the FCC Form 470 was created (EST).'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
...
#         help_text='Name of the person who created the FCC Form 470.',
#         max_length=255,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     certified_datetime = models.DateTimeField(
#         verbose_name='Certified Date/Time',
#         help_text=(
#             'Exact date and time the FCC Form 470 was certified (EST).'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
...
#         help_text='The person who certified the FCC Form 470.',
#         max_length=255,
#         unique=False,
#         null=True,
#         blank=True,
...
#         help_text=(
#             'Exact date and time the FCC Form 470 was last modified '
#             '(EST).'
#         ),
#         unique=False,
#         null=True,
...
#         help_text=(
#             'Name of the person who last modified the FCC Form 470.'
#         ),
#         max_length=255,
#         unique=False,
#         null=True,
...
#         Enitity,
#         on_delete=models.CASCADE,
#         verbose_name='470 Parent Organization',
#         help_text='Entity that filed the FCC Form 470.',
#         related_name='form_470_entity',
#         null=False,
#         blank=False,
#     )
#     number_of_eligible_entities = models.IntegerField(
#         verbose_name='Number of Eligible Entities',
#         help_text=(
#             'Number of entities eligible for the services requested '
#             'through an FCC Form 470.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
...
#         help_text=(
#             'Name of the main contact provided by the applicant on the '
#             'FCC Form 470.'
#         ),
#         max_length=255,
#         unique=False,
...
#         blank=True,
#     )
#     contact_address1 = models.CharField(
#         verbose_name='Contact Address 1',
#         help_text=(
#             'Street address line 1 for the application\'s main contact.'
#         ),
#         max_length=255,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     contact_address2 = models.CharField(
#         verbose_name='Contact Address 2',
#         help_text=(
#             'Street address line 2 for the application\'s main contact.'
#         ),
#         max_length=255,
#         unique=False,
#         null=True,
...
#         help_text='City of the application\'s main contact.',
#         max_length=100,
#         unique=False,
#         null=True,
#         blank=True,
...
#         help_text='State of the application\'s main contact.',
#         max_length=2,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     contact_zip = models.CharField(
#         verbose_name='Contact Zip Code',
#         help_text='Zip code of the application\'s main contact.',
#         max_length=10,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     contact_zipcode_ext = models.CharField(
#         verbose_name='Contact Zip Code Ext',
#         help_text=(
#             'Zip code extension of the application\'s main contact.'
#         ),
#         max_length=4,
#         unique=False,
#         null=True,
...
#         help_text='Phone number of the application\'s main contact.',
#         max_length=15,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     contact_phone_ext = models.CharField(
#         verbose_name='Contact Phone Ext',
#         help_text=(
#             'Phone number extension of the application\'s main contact.'
#         ),
#         max_length=10,
#         unique=False,
#         null=True,
...
#         help_text=(
#             'Email address of the main contact. This contact is used '
#             'as the first point of contact through the funding request '
#             'process.'
#         ),
#         max_length=255,
#         unique=False,
...
#         verbose_name='Technical Contact Name',
#         help_text=(
#             'Name of the technical contact provided by the applicant '
#             'of the FCC Form 470.'
#         ),
#         max_length=255,
#         unique=False,
...
#         help_text=(
#             'Title of the technical contact provided by the applicant '
#             'on the FCC Form 470.'
#         ),
#         max_length=100,
#         unique=False,
...
#         verbose_name='Technical Contact Phone',
#         help_text=(
#             'Phone number of the technical contact provided by the '
#             'applicant on the FCC Form 470.'
#         ),
#         max_length=15,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     technical_contact_phone_ext = models.CharField(
#         verbose_name='Technical Contact Phone Ext',
#         help_text=(
#             'Phone extension of the technical contact provided by the '
#             'applicant of the FCC Form 470.'
#         ),
#         max_length=10,
#         unique=False,
#         null=True,
...
#         help_text=(
#             'Email address of the technical contact provided by the '
#             'applicant of the FCC Form 470.'
#         ),
#         max_length=255,
#         unique=False,
...
#         verbose_name='Authorized Person Name',
#         help_text=(
#             'Name of the person authorized to certify the FCC Form 470.'
#         ),
#         max_length=255,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     authorized_person_address = models.CharField(
#         verbose_name='Authorized Person Address 1',
#         help_text=(
#             'Address of the person authorized to certify the FCC Form '
#             '470.'
#         ),
#         max_length=255,
#         unique=False,
...
#         blank=True,
#     )
#     authorized_person_city = models.CharField(
#         verbose_name='Authorized Person City',
#         help_text='City of the person authorized to certify the FCC ' \
#         'Form 470.',
#         max_length=100,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     authorized_person_state = models.CharField(
#         verbose_name='Authorized Person State',
#         help_text=(
#             'State of the person authorized to certify the FCC Form 470.'
#         ),
#         max_length=2,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     authorized_person_zip = models.CharField(
#         verbose_name='Authorized Person Zip Code',
#         help_text=(
#             'Zip code of the person authorized to certify the FCC Form '
#             '470.'
#         ),
#         max_length=10,
#         unique=False,
...
#         blank=True,
#     )
#     authorized_person_zipcode_ext = models.CharField(
#         verbose_name='Authorized Person Zip Code Ext',
#         help_text=(
#             'Zip code extension of the person authorized to certify '
#             'the FCC Form 470'
#         ),
#         max_length=4,
#         unique=False,
...
#         verbose_name='Authorized Person Phone',
#         help_text=(
#             'Phone number of the person authorized to certify the FCC '
#             'Form 470.'
#         ),
#         max_length=15,
#         unique=False,
...
#         blank=True,
#     )
#     authorized_person_phone_ext = models.CharField(
#         verbose_name='Authorized Person Phone Ext',
#         help_text=(
#             'Phone extension of the person authorized to certify the '
#             'FCC Form 470.'
#         ),
#         max_length=10,
#         unique=False,
...
#         verbose_name='Authorized Person Email',
#         help_text=(
#             'Email address of the person authorized to certify the FCC '
#             'Form 470.'
#         ),
#         max_length=255,
#         unique=False,
...
#         verbose_name='Authorized Person Title',
#         help_text=(
#             'Title of the person authorized to certify the FCC Form 470.'
#         ),
#         max_length=100,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     authorized_person_employer = models.CharField(
#         verbose_name='Authorized Person Employer',
#         help_text=(
#             'Employer of the person authorized to certify the FCC Form '
#             '470.'
#         ),
#         max_length=255,
#         unique=False,
...
#         blank=True,
#     )
#     category_one_description = models.TextField(
#         verbose_name='Category One Description',
#         help_text=(
#             'Description of Category One services (Internet Access '
#             'and/or Telecommunications) the applicant seeks discounts '
#             'for.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     category_two_description = models.TextField(
#         verbose_name='Category Two Description',
#         help_text=(
#             'Description of Category Two services (Internal '
#             'Connections, Basic Maintenance of Internal Connections, '
#             'or Managed Internal Broadband Services) the applicant '
#             'seeks discounts for.'
#         ),
#         unique=False,
#         null=True,
...
#         help_text=(
#             'Applicant can choose to use an installment payment plan '
#             'for the non-discounted portion of any special '
#             'construction charges associated with the request.'
#         ),
#         max_length=20,
#         choices=USAC_INSTALLMENT_TYPE,
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     installment_min_range_years = models.IntegerField(
#         verbose_name='Installment Min Range Years',
#         help_text=(
#             'Minimum number of years over which the applicant will '
#             'amortize the costs.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     installment_max_range_years = models.IntegerField(
#         verbose_name='Installment Max Range Years',
#         help_text=(
#             'Maximum number of years over which the applicant will '
#             'amortize the costs.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     rfp_identifier = models.BooleanField(
#         verbose_name='RFP Identifier',
#         help_text=(
#             'Indicates whether a Request for Proposal (RFP) document '
#             'was provided for the services requested.'
#         ),
#         choices=YESNO,
#         default=False,
#         unique=False,
...
#         blank=True,
#     )
#     state_or_local_restrictions = models.BooleanField(
#         verbose_name='State or Local Restrictions',
#         help_text=(
#             'Indicates if there are state or local procurement or '
#             'competitive bidding requirements that apply to the '
#             'procurement of services sought by the applicant.'
#         ),
#         choices=YESNO,
#         default=False,
#         unique=False,
...
#         blank=True,
#     )
#     state_or_local_restrictions_description = models.TextField(
#         verbose_name='State or Local Restrictions Description',
#         help_text=(
#             'Indicates if there are state or local procurement or '
#             'competitive bidding requirements that apply to the '
#             'applicant\'s procurement of services.'
#         ),
#         unique=False,
#         null=True,
#         blank=True,
#     )
#     statewide_state = models.BooleanField(
#         verbose_name='Statewide State',
#         help_text=(
#             'Indicates that the FCC Form 470 is for the entire state.'
#         ),
#         choices=YESNO,
#         default=False,
#         unique=False,
...
#         blank=True,
#     )
#     all_public_schools_districts = models.BooleanField(
#         verbose_name='All Public Schools Districts',
#         help_text=(
#             'Indicates that all public schools/districts in the state '
#             'are included for the FCC Form 470.'
#         ),
#         choices=YESNO,
#         default=False,
#         unique=False,
...
#         blank=True,
#     )
#     all_non_public_schools = models.BooleanField(
#         verbose_name='All Non-Public Schools',
#         help_text=(
#             'Indicates that all non-public schools in the state are '
#             'included for the FCC Form 470.'
#         ),
#         choices=YESNO,
#         default=False,
#         unique=False,
...
#         blank=True,
#     )
#     all_libraries = models.BooleanField(
#         verbose_name='All Libraries',
#         help_text=(
#             'Indicates that all libraries in the state are included '
#             'for the FCC Form 470.'
#         ),
#         choices=YESNO,
#         default=False,
#         unique=False,
...
#         help_text=(
#             'Indicates whether the form version of the application is '
#             '"current" or "original." It can be used to aggregate the '
#             'data between current and original applications. "Current" '
#             'is the view of the form processed by USAC. "Original" is '
#             'the view of the form originally submitted by the '
#             'applicant upon certification.'
#         ),
#         max_length=20,
#         choices=USAC_470_FORM_VERSION,
#         unique=False,
#         null=True,
#         blank=True,
#     )
...
#     class Meta:
#         ordering = ('application_number', 'form_version',)
#         verbose_name = 'Form 470 Basic Information'
#         verbose_name_plural = 'Forms 470 Basic Information'
